...
export default function ProjectCard({
  ...
  return (
    <div className="card-scene flex-shrink-0" style={{ aspectRatio: "1/1", width: "clamp(220px, 28vw, 380px)" }}>
        ...
        >
          <div>
            <span
              ...
              style={{ color: "var(--green-light)", fontFamily: "var(--font-body)" }}
            >
              {tag}
            </span>
          </div>
        ...
        <div className="card-back card-face overflow-hidden">
          <div className="relative w-full h-full">
            ...
            <div
              ...
              style={{ background: "linear-gradient(to top, rgba(40,93,63,0.85) 0%, transparent 60%)" }}
            >
              <span
                className="text-sm"
